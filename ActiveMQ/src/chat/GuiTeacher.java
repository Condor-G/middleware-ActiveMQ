...
public class GuiTeacher extends JFrame implements ActionListener, KeyListener, MessageListener {

	/**
	 *
	 */
	private static final long serialVersionUID = 6406912207502138349L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiTeacher frame = new GuiTeacher();
	...
	void queue() {
		...
		try {
			...
			destination1 = session1.createQueue("Teacher");
			destination2 = session2.createQueue("Student");
			// 得到消息生成者【发送者】
